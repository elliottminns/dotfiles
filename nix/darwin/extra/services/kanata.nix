...
# and PR https://github.com/nix-darwin/nix-darwin/pull/1561
{
  ...
  stableKanataExec = "${cfg.stableBinaryPath}/kanata";
  ...
  mkService = name: keyboard:
    lib.nameValuePair (mkName name) {
      command =
        "${stableKanataExec} --cfg ${keyboard.configFile}"
...
in {
  options.services.kanata = {
    ...
    stableBinaryPath = lib.mkOption {
      type = lib.types.str;
      default = "/usr/local/libexec/nix-darwin/kanata";
      description = ''
